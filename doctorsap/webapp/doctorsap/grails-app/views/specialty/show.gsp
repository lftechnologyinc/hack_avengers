	...
	<body>
		...
		<div id="show-specialty" class="content scaffold-show" role="main">
			...
			<ol class="property-list specialty">
				...
				<g:if test="${specialtyInstance?.tags}">
				<li class="fieldcontain">
					<span id="tags-label" class="property-label"><g:message code="specialty.tags.label" default="Tags" /></span>
					
						<span class="property-value" aria-labelledby="tags-label"><g:fieldValue bean="${specialtyInstance}" field="tags"/></span>
